...
function ProfileDropdown() {
  return (
    <Menu as="div">
      ...
      >
        <Menu.Items className="z-10 py-3 mr-3 md:mr-5 w-28 lg:w-40 xl:w-48 absolute right-0 text-left font-light text-sm lg:text-lg xl:text-xl bg-yellow-500 text-gray-900 rounded-md shadow-md focus:outline-none">
          <Menu.Item>
            {({ active }) => (
              <button
