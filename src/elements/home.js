  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-grow relative text-center z-10">
        <h1 className="text-3xl pt-4 tracking-wide font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-50 via-blue-100 to-purple-50">UI ELEMENTS</h1>
        <div className="px-12 mx-8 w-full flex">
          ...
          <div className="mt-40 w-1/2 text-center text-purple-50 font-bold tracking-wide leading-tight text-5xl">
            <span className="font-hero-primary">Visual Inspiration</span><br/> 
