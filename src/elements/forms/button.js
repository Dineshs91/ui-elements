...
function ClassicButtons() {
  return (
    <div>
      <h3 className="text-xl font-normal text-center">Classic Buttons</h3>
      <div className="h-12 flex pt-8 items-center justify-center space-x-8">
        <div className='group w-44'>
          <button className="flex items-center px-4 py-2 rounded-lg bg-green-500 text-base font-medium text-white border border-b-4 border-green-900 group-hover:border-b-2 group-hover:mt-1">
        ...
        <div className='w-36'>
          <div className='group'>
            <div className='w-fit overflow-hidden border-2 border-b-8 bg-yellow-900 rounded-xl border-yellow-900 group-hover:border group-hover:mt-1'>
              <button className="w-full flex items-center px-4 py-2 rounded-lg bg-yellow-500 shadow-sm text-base font-medium text-white">
                <p className="tracking-wide">Sign Out</p>
